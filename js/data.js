let data = {
   "projects":[
               ...
               },
               {
                   ...
                   "equipe" : ["<a class='colab_style' target=”_blank” href='https://elisasibert.myportfolio.com/home'>Élisa SIBERT</a>", "Anaïs VERRIER", "Clara GUYOT"]
               },
               {
               ...
               },
               {
                   ...
                   "equipe" : ["<a class='colab_style' target=”_blank” href='https://kronosvevo.wixsite.com/website/videos'>Titouan POUDENS</a>", "<a class='colab_style' target=”_blank” href='https://www.nathanael-rovere.fr/index.html'>Nathanaël ROVERE</a>", "<a class='colab_style' target=”_blank” href='http://julianbruxelle.fr/about'>Julian BRUXELLE</a>"]
               },
               {
                   "titre": "Interphobe",
                   ...
                   "equipe" : ["<a class='colab_style' target=”_blank” href='http://thibaultguichard21.free.fr/'>Thibault GUICHARD</a>", "Tristan GROSSETTI", "<a class='colab_style' target=”_blank” href='https://www.nathanael-rovere.fr/index.html'>Nathanaël ROVERE</a>", "Mathilde WILDMAN", "<a class='colab_style' target=”_blank” href='https://antoineballand.com/'>Antoine BALLAND</a>"]
               },
               {
